            ...
            <div class="row">
                <div class="col-4">
                    <div class="text-center d-flex">
                        ...
                        <a href="<?php echo base_url() ?>proveedor" class="btn btn-warning"><i class="fa-solid fa-arrow-rotate-left"></i> Regresar</a>
                    ...
                    <tbody>
                        <?php foreach($datos as $dato){ ?>
                            ...
                            <tr id="<?php echo $dato['id_proveedor']; ?>">
                                ...
                                <td> <a data-id="<?php echo $dato['id_proveedor']; ?>" class="btn btn-primary btnReturn"><i class="fas fa-arrow-alt-circle-up"></i></a></td>
    ...
    <script>
            $(document).ready(function() {
                ...
                $('body').on('click', '.btnReturn', function(){
                    ...
                    $.get('<?php echo base_url() ?>proveedor/reingresar/'+proveedor_id, function (data){
