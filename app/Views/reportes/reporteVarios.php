                        ...
                        <div class="text-center">
                            <div class="radio_contenedor">
                                <div class="radio_caja">
                                    <input type="radio" id="tipo_entrada" name="tipo" value="tipo_entrada" checked>
                                    <label for="tipo_entrada">Tipo Entrada</label>
                                </div>
                                <div class="radio_caja">
                                    <input type="radio" id="tipo_salida" name="tipo" value="tipo_salida">
                                    <label for="tipo_salida">Tipo Salida</label>
                                </div>
                                <div class="radio_caja">
                                    <input type="radio" id="proveedor" name="tipo" value="proveedor" checked>
                                    <label for="proveedor">Proveedores</label>
                                </div>
                                <div class="radio_caja">
                                    <input type="radio" id="usuario" name="tipo" value="usuario">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    generaPdfLink.addEventListener('click', function(event) {
        ...
        var url = "<?php echo base_url() ?>reportes/generaPdfReporteVarios/" + fechaInicio + "/" + fechaFin + "/" + tipo;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    generaPdfLink.addEventListener('click', function(event) {
        ...
        // Construye la URL con los valores
        var url = "<?php echo base_url() ?>reportes/generaExcelReporteVarios/" + fechaInicio + "/" + fechaFin + "/" + tipo;
