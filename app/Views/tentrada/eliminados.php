            ...
            <div class="row">
                <div class="col-4">
                    <div class="text-center d-flex">
                        ...
                        <a href="<?php echo base_url() ?>tentrada" class="btn btn-warning"><i class="fa-solid fa-arrow-rotate-left"></i> Regresar</a>
                    ...
                    <tbody>
                        <?php foreach($datos as $dato){ ?>
                            ...
                            <tr id="<?php echo $dato['id_tipoentrada']; ?>">
                                ...
                                <td> <a data-id="<?php echo $dato['id_tipoentrada']; ?>" class="btn btn-primary btnReturn"><i class="fas fa-arrow-alt-circle-up"></i></a></td>
    ...
    <script>
            $(document).ready(function() {
                ...
                $('body').on('click', '.btnReturn', function(){
                    ...
                    $.get('<?php echo base_url() ?>tentrada/reingresar/'+entrada_id, function (data){
